...
tokenizer = AutoTokenizer.from_pretrained(f'{MODEL_DIR}/fine_tuned')
...
base_model = AutoModelForSequenceClassification.from_pretrained(f"{LLM_DIR}/llama32_1b/", num_labels=2, quantization_config=quant_config)
base_model.config.pad_token_id = tokenizer.pad_token_id

model = PeftModelForSequenceClassification.from_pretrained(
    base_model, 
    f'{MODEL_DIR}/fine_tuned',
...
pipe = DeliriumLLM(model=model, tokenizer=tokenizer, batch_size=32, padding="max_length", truncation=True, max_length=1024)
