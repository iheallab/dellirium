...
# Load tokenizer
tokenizer = AutoTokenizer.from_pretrained(f"{LLM_DIR}/gatortron/", trust_remote_code=True)
...
# LoRA configuration
peft_params = LoraConfig(task_type="SEQ_CLS", inference_mode=False, r=8, lora_alpha=16, lora_dropout=0.1, target_modules=["query", "key", "value", "dense"])
