...
base_model = AutoModelForSequenceClassification.from_pretrained(f"{LLM_DIR}/gatortron/", num_labels=2, quantization_config=quant_config)
...
pipe = DeliriumLLM(model=model, tokenizer=tokenizer, batch_size=32, padding="max_length", truncation=True, max_length=512)
